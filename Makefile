BINDIR=/home/samuel/src/toolchain-arm_gcc-4.5.1+l_uClibc-0.9.32_eabi
#/arm-openwrt-linux-uclibcgnueabi/bin
CONFDIR=/etc
WARNFLAGS=-Wall  -W -Wshadow
CFLAGS?=-Os -g ${WARNFLAGS} -I ${BINDIR}/include -L ${BINDIR}/lib
CC=$(BINDIR)/bin/arm-openwrt-linux-uclibcgnueabi-gcc
